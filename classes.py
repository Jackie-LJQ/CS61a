...
class Player:
    def __init__(self, deck, name):
        ...
        self.name = name
        "*** YOUR CODE HERE ***"
        self.hand = [self.deck.draw() for n in range(5)]
    ...
    def play(self, card_index):
        ...
        """
        "*** YOUR CODE HERE ***"
        target_card = self.hand[card_index]
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        attack_value, defense_value = other_card.attack, other_card.defense
        for i in range(len(player.deck.cards)):
            player.deck.cards[i].attack += attack_value
            player.deck.cards[i].defense += defense_value
            copy_oppo_deck = opponent.deck.cards[:]
        for oppo_card in copy_oppo_deck:
            if other_card.attack == oppo_card.attack or other_card.defense == oppo_card.defense:
                opponent.deck.cards.remove(oppo_card)
